...
describe("types", () => {
  ...
  test("should be usable with `dir` and `opts` arguments", () => {
...
describe("basics", () => {
  test("should return the file if found", async () => {
  ...
  test("should return a 404 response (default) if not found", async () => {
    const server = utils.http();
...
describe("URI encoding", () => {
  test("should work when the request path contains accented characters :: dev", async () => {
  ...
  test("should work when the request path contains encoded characters :: dev", async () => {
    const server = utils.http({ dev: true });
  ...
  test("should work when the request path contains accented characters :: prod", async () => {
  ...
  test("should work when the request path contains encoded characters :: prod", async () => {
    const server = utils.http({ dev: false });
  ...
  test("should work when the request path contains space encoded :: dev", async () => {
    const server = utils.http({ dev: true });
  ...
  test("should work when the request path contains space encoded :: prod", async () => {
    const server = utils.http({ dev: false });
  ...
  test('should not treat "/foo%2Fbar.txt" the same as "/foo.bar.txt" path :: dev', async () => {
    const server = utils.http({ dev: true });
  ...
  test('should not treat "/foo%2Fbar.txt" the same as "/foo.bar.txt" path :: prod', async () => {
    const server = utils.http({ dev: false });
...
describe("index.html", () => {
  test('should handle direct "index.html" requests', async () => {
    const server = utils.http();
  ...
  test('should treat "/" as "/index.html" request', async () => {
    const server = utils.http();
  ...
  test('should treat "/about" as "/about/index.htm" request', async () => {
    const server = utils.http();
  ...
  test('should treat "/contact" as "/contact/index.html" request', async () => {
    const server = utils.http();
  ...
  test('should treat "/blog" as "/blog.html" request', async () => {
    const server = utils.http();
...
describe("extensions", () => {
  test("should limit which extensions are assumed for index lookup", async () => {
    const server = utils.http({
      extensions: ["html"],
    });
  ...
  test("should extend which extensions are assumed for any request", async () => {
    const server = utils.http({
      extensions: ["js", "css"],
    });
...
describe("security", () => {
  test("should prevent directory traversal attacks :: prod", async () => {
    const server = utils.http({ dev: false });
  ...
  test("should prevent directory traversal attacks :: dev", async () => {
    const server = utils.http({ dev: true });
  ...
  test("should prevent files starting with directory name :: dev", async () => {
    const server = utils.http({ dev: true });
...
describe("single", () => {
  test('should maintain "index.html" assumptions', async () => {
  ...
  test("should serve assets when requested directly", async () => {
    const server = utils.http({ single: true });
  ...
  test('should serve root "index.html" for paths without assets', async () => {
    const server = utils.http({ single: true });
  ...
  test("should use custom fallback when `single` is a string", async () => {
  ...
  test('should NOT fallback to "index.html" for URLs with extension', async () => {
    const server = utils.http({ single: true });
...
describe("ignores", () => {
  test('should be able to fallback any URL to "index.html" when desired', async () => {
  ...
  test("should provide custom RegExp pattern to ignore", async () => {
    const server = utils.http({
      single: true,
      ignores: /^[/]foo/,
    });
  ...
  test("should provide custom String pattern to ignore", async () => {
    const server = utils.http({
      single: true,
      ignores: "^/foo",
    });
  ...
  test("should provide mulitple RegExp patterns to ignore", async () => {
    const server = utils.http({
      single: true,
      ignores: [/^[/]foo/, /bar/],
    });
  ...
  test("should provide mulitple String patterns to ignore", async () => {
    const server = utils.http({
      single: true,
      ignores: ["^/foo", "bar"],
    });
...
describe("dotfiles", () => {
  test("should reject hidden files by default (dev: false)", async () => {
    const server = utils.http();
  ...
  test("should reject hidden files by default (dev: true)", async () => {
    const server = utils.http({ dev: true });
  ...
  test("should treat dotfiles with fallback during `single` mode", async () => {
    const server = utils.http({ single: true });
  ...
  test('should always allow access to ".well-known" directory contents', async () => {
    const server = utils.http();
  ...
  test("should allow requests to hidden files only when enabled", async () => {
...
describe("dev", () => {
  ...
  test("should set default `Cache-Control` header value", async () => {
    const server = utils.http({ dev: true });
...
describe("etag", () => {
  test('should include an "ETag" HTTP header value', async () => {
  ...
  test('should be "weak" variant and calculated from file stats', async () => {
    const server = utils.http({ etag: true });
  ...
  test('should allow "If-None-Match" directive to function', async () => {
    const server = utils.http({ etag: true });
  ...
  test("should force `Cache-Control` header in `dev` mode", async () => {
...
describe("brotli", () => {
  test('should require "Accept-Encoding" match to do anything', async () => {
  ...
  test("should serve prepared `.br` file of any asset, if found", async () => {
    const server = utils.http({ brotli: true });
    const headers = { "Accept-Encoding": "br,gzip" };
  ...
  test('should be preferred when "Accept-Encoding" allows both', async () => {
...
describe("gzip", () => {
  ...
  test("should serve prepared `.gz` file of any asset, if found", async () => {
    const server = utils.http({ gzip: true });
    const headers = { "Accept-Encoding": "br,gzip" };
  ...
  test('should defer to brotli when "Accept-Encoding" allows both', async () => {
    const server = utils.http({ gzip: true, brotli: true });
    const headers = { "Accept-Encoding": "br,gzip" };
...
describe("maxAge", () => {
  test('should set the "Cache-Control" HTTP header value', async () => {
  ...
  test("should accept `0` value", async () => {
  ...
  test("should ignore `null` value", async () => {
...
describe("immutable", () => {
  test('should append the `immutable` directive to "Cache-Control" header value', async () => {
  ...
  test("should work with `maxAge=0` value", async () => {
  ...
  test("should not do anything without a `maxAge` option enabled", async () => {
...
describe("ranges", () => {
  test('should send the requested "Range" slice :: start', async () => {
    const server = utils.http();
  ...
  test('should send the requested "Range" slice :: middle', async () => {
    const server = utils.http();
  ...
  test('should send the requested "Range" slice :: end', async () => {
    const server = utils.http();
  ...
  test('should send the requested "Range" slice :: full', async () => {
    const server = utils.http();
  ...
  test("should assume the end-value is final byte when not included", async () => {
    const server = utils.http();
  ...
  test("should assume the end-value is final byte when not included :: full", async () => {
    const server = utils.http();
  ...
  test("should throw `416` when range start cannot be met (overflow)", async () => {
    const server = utils.http();
  ...
  test("should shrink range end if it cannot be met (overflow)", async () => {
    const server = utils.http();
  ...
  test("should not mutate response headers on subsequent non-Range requests :: dev", async () => {
    const server = utils.http({ dev: true });
  ...
  test("should not mutate response headers on subsequent non-Range requests :: prod", async () => {
    const server = utils.http({ dev: false });
...
describe("setHeaders", () => {
  test("should be able to set new response headers", async () => {
    const server = utils.http({
      setHeaders(res) {
  ...
  test('should be able to customize "Content-Type" header', async () => {
    const server = utils.http({
      setHeaders(res) {
  ...
  test('should be able to customize "Cache-Control" header', async () => {
    const server = utils.http({
      maxAge: 100,
      immutable: true,
      setHeaders(res) {
  ...
  test('should be able to customize "Last-Modified" header', async () => {
    const server = utils.http({
      etag: true,
      setHeaders(res) {
  ...
  test('should receive "path" argument', async () => {
    const server = utils.http({
      setHeaders(res, path) {
  ...
  test('should receive "stats" argument', async () => {
    const server = utils.http({
...
describe("onNoMatch", () => {
  test("should be called instead of default 404 response", async () => {
    const server = utils.http({
      onNoMatch() {
